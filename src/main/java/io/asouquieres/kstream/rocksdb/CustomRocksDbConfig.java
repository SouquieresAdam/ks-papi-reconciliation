package io.asouquieres.kstream.rocksdb;
...
import java.util.Map;
    ...
    This class allow to bound the total memory to be used (off-heap) by rocks DB
    Making sure that Write Buffer and Read buffer use a shared & bounded maximum total of memory.
    ...
    **/
    ...
    private static final long TOTAL_MEMTABLE_MEMORY = 1024 * 1024 * 50; // 100 MB
    private static final int BLOCK_SIZE = 4096; // 4KB
    private static final int N_MEMTABLES = 3;
    private static final int MEMTABLE_SIZE = 1024 * 1024 * 150;;
