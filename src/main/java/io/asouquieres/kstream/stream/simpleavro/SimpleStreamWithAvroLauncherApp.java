...
public class SimpleStreamWithAvroLauncherApp implements CommandLineRunner {

    private static final Logger logger = Logger.getLogger(SimpleStreamWithAvroLauncherApp.class);
    private final MeterRegistry meterRegistry;
    private final ConfigurableApplicationContext applicationContext;

    public SimpleStreamWithAvroLauncherApp(MeterRegistry meterRegistry, ConfigurableApplicationContext applicationContext) {
        this.meterRegistry = meterRegistry;
        this.applicationContext = applicationContext;
    }

    public static void main(String[] args) {
        SpringApplication.run(SimpleStreamWithAvroLauncherApp.class, args);
    }
